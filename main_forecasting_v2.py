...
class Forecasting():
    ...
    def save_model(self, best_model, best_model_path):
        ...
        torch.save(best_model.state_dict(),f'{best_model_path}/{self.model_name}.pt')
    ...
    def pred_data(self, init_model, best_model_path):
        ...
        # load best model
        init_model.model.load_state_dict(torch.load(f'{best_model_path}/{self.model_name}.pt'))
